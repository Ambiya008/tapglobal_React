            ...
            <div className="card-content">
              ...
              <ul>
                <li>
                  ...
                  <a href="https://tappayments.com" target="_blank" rel="noopener noreferrer">Visit Website →</a>
                </li>
                <li>
                  <h4>Tap Remittance</h4>
                  <p>International money transfer services</p>
                  <a href="https://tapremit.com" target="_blank" rel="noopener noreferrer">Visit Website →</a>
                </li>
                <li>
                  <h4>Tap Capital</h4>
                  <p>Investment and financial services</p>
                  <a href="https://tapcapital.com" target="_blank" rel="noopener noreferrer">Visit Website →</a>
                </li>
              </ul>
            </div>
          </div>
